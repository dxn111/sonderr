...
assert.match(appSource, /Wallet follow-ups: when the user answers a short clarification such as “Sol”/);
assert.match(appSource, /Never print pseudo-tool markup such as/);
const packageVersion = JSON.parse(fs.readFileSync(require.resolve("../package.json"), "utf8")).version;
assert.match(appSource, /version:packageJson\.version/);
